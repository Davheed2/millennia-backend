...
export const forgotPasswordEmail = (data: { name: string; resetLink: string }) => {
    ...
    <p>
      This link will expire in <strong>15 minutes</strong>. If you didn’t request this password reset, you can safely ignore this message or <a href="https://alpsector.com/help" style="color: rgb(112, 232, 204); text-decoration: none;">contact support</a> immediately.
    </p>
