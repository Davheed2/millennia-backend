            ...
            <tr>
              <td align="center">
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      <a href="https://www.alpsector.org/${isApproved ? 'dashboard' : 'kyc'}" class="button" style="background-color: #1D4ED8; border-radius: 20px; color: #ffffff; display: inline-block; text-decoration: none; padding: 12px 30px; font-size: 16px;">
    ...
    <p>
      ${
				isApproved
					...
					: 'If you have any questions or need assistance, please <a href="https://www.alpsector.org/contact" style="color:#1D4ED8; text-decoration: none;">contact our support team</a>.'
			}
    </p>
