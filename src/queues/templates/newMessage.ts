...
export const NewMessageEmail = (data: { name: string }) => {
    ...
    <p>
      If you have any questions or need help, feel free to <a href="https://www.millenniatrades.com/contact" style="color:#1D4ED8; text-decoration: none;">contact our support team</a>.
    </p>
