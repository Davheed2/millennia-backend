...
export const WithdrawalProcessingEmail = (data: { name: string; amount: number; reference: string }) => {
	return baseTemplate(
        ...
        <div style="color: #51545E; font-size: 16px; line-height: 1.6;">
          ...
          <p style="margin: 0 0 20px;">
            You’ll be notified once your withdrawal is completed. If you have any questions, please visit our <a href="https://www.millenniatrades.com/contact" style="color: #3B82F6; text-decoration: none; font-weight: 500;">Support Center</a>.
          </p>
